...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './project-user-role-map.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTUSERROLEMAP_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTUSERROLEMAP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTUSERROLEMAP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTUSERROLEMAP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTUSERROLEMAP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTUSERROLEMAP actions', async () => {
      const expectedActions = [
        {
